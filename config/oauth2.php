...
return [
    ...
    */
    ...
    'grant_types' => [
        ...
        'motorista' => [
            #'class' => '\League\OAuth2\Server\Grant\PasswordGrant',
            'class' => '\Multitest\OAuth2\MotoristaPasswordGrant',
            'callback' => '\Multitest\OAuth2\MotoristaPasswordVerifier@verify',
            'access_token_ttl' => 3600
        ],

        'cliente' => [
            #'class' => '\League\OAuth2\Server\Grant\PasswordGrant',
            'class' => '\Multitest\OAuth2\ClientePasswordGrant',
            'callback' => '\Multitest\OAuth2\ClientePasswordVerifier@verify',
            'access_token_ttl' => 3600
        ],
